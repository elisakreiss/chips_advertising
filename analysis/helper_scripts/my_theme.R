theme_chips <- function(base_size = 11, base_family = "",
  ...
  theme(
    ...
    text =               element_text(
      ...
      colour = "darkgrey", size = base_size,
    ...
    axis.line.x =        NULL,
    axis.line.y =        NULL,
    axis.text =          element_text(size = rel(0.8), colour = "darkgrey"),
...
theme_set(theme_chips())
# theme_set(theme_bw())

a = 1:10
b = 2:11
blub = data.frame(a,b)
ggplot(blub,aes(x=a,y=b)) +
  geom_point()
