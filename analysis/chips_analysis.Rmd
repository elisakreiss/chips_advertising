...
df$PriceCategory = ifelse(df$Price >= 1.1,"expensive","cheap")
...
# exclude KettleChips, because the text is only English
# think about Funny Chipsfrisch, since they were on discount price
