...
plot_totalWordCount = df %>%
                 ...
                 summarise(AvgTotalWordCount = mean(TotalWordCount))
...
plot_avgLength = df %>%
                 ...
                 group_by(PriceCategory) %>%
                 summarise(AverageWordLength = mean(AverageWordLength))

ggplot(plot_avgLength,aes(x=PriceCategory,y=AverageWordLength)) +
...
plot_totalNegMarkers = df %>%
                 ...
                 group_by(PriceCategory) %>%
                 summarise(AvgNegativeMarkers = mean(NegativeMarkers))
...
plot_HealthyPhrases = df %>%
                 ...
                 group_by(PriceCategory) %>%
                 summarise(AvgHealthyPhrases = mean(HealthyPhrases))
...
plot_NaturalnessPhrases = df %>%
                 ...
                 group_by(PriceCategory) %>%
                 summarise(AvgNaturalnessPhrases = mean(NaturalnessPhrases))
...
plot_ComparativePhrases = df %>%
                 ...
                 group_by(PriceCategory) %>%
                 summarise(AvgComparativePhrases = mean(ComparativePhrases))
...
plot_AuthenticityPhrases = df %>%
                 ...
                 group_by(PriceCategory) %>%
                 summarise(AvgAuthenticityPhrases = mean(AuthenticityPhrases))
...
plot_Phrases = df %>%
               ...
               summarise(AvgOccurrences = mean(Occurrences))
...
plot_relPhrases = relativePhrases %>%
               ...
               select(PriceCategory,Phrases,Occurrences) %>%
               group_by(PriceCategory,Phrases) %>%
               summarise(AvgRelOccurrences = mean(Occurrences))
